...
> ⚠️ **ВНИМАНИЕ: Игра разрабатывается СТРОГО под платформу iOS (портретная ориентация, 1080x2400).** 
> *Сборкой и тестированием iOS проекта занимается **Программист 1 (Build Master)***.
...
**Зона ответственности:** Глобальные системы, Автозагрузки, сохранение, сетка, экспорт проекта Xcode на iOS.
...
4. **Сборка тестовых билдов iOS и выдача команде.**
