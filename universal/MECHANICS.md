...
- **Периодичность:** каждые N минут игроку нужно довести оборону до требуемого уровня, чтобы не потерять прогресс.
- **Стат:** `Defence` — статка игрока, отвечающая за уровень обороны.
- **Механика сравнения:** столкновение происходит сравнением значения `Defence` и `Класс опасности` врага.
- **Класс опасности:** у противников есть статка `Класс опасности`, которая задаёт требуемый минимум обороны для игрока. Значение по умолчанию = 10.
- **Последствия провала:** если игрок не достигает требуемого значения по `Defence`, он теряет модули в количестве `floor(Класс_опасности / 5)`.
- **Бонус за успех:** если игрок достигает или превышает пороговое значение, он получает скидку на постройку следующих `Класс_опасности / 2.5` построек (округление по желанию дизайнера).
- **Усиление обороны:** значение `Defence` повышается путём постройки оборонительных модулей.
- **Баланс по энергии:** дефолтный модуль обороны потребляет столько же энергии, сколько 1 жилой модуль.
