...
- **Стат:** `Defence` — статка корабля, отвечающая за уровень обороны.
...
- **Последствия провала:** если игрок не достигает требуемого значения по `Defence`, он теряет модули в количестве `(Класс_опасности - Defence) / 10 `.
- **Бонус за успех:** если игрок достигает или превышает пороговое значение, он получает скидку 50% на постройку следующих `Класс_опасности / 10` построек (округление в меньшую).
